...
>
> 时间跨度：2026-09-02 → 2026-09-14。所有数字均为实测（测量方法见 [docs/05-playbook.md](05-playbook.md)）。
...
单路 decode 的剩余差距在 W4 GEMM matvec（llama.cpp 294 GB/s vs vLLM 侧 ~180-205 GB/s），Triton 语言层已证明闭合不了，唯 HIP/布局路线——见 [docs/04](04-w4a8-matvec-wall.md)。
...
- [01 · 栈与量化](01-stack-and-quantization.html)
- [02 · llama.cpp 基线与调优](02-llamacpp.html)
- [03 · fp8 KV 病灶链与自写 decode 内核](03-fp8kv-pathology-and-kernel.html)
- [04 · W4A8 matvec 墙](04-w4a8-matvec-wall.html)
- [05 · 运行手册与未竟之路](05-playbook.html)
